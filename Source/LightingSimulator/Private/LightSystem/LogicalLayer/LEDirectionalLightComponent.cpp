...
TArray<FString> ULEDirectionalLightComponent::GetDataAsJson(const int deepth)
{
	TArray<FString> ans;
	...
	ans.Add(ULightEntityHelper::StrStrUnParsor("SourceAngle", FString::SanitizeFloat(this->LightSourceAngle), Deepth));
	ans.Add(ULightEntityHelper::StrStrUnParsor("SourceSoftAngle", FString::SanitizeFloat(this->LightSourceSoftAngle), Deepth));
...
void ULEDirectionalLightComponent::SetDataFromJson(TArray<FString> dataStrList, int& deepth)
{
	int stackNum = 0;
	FString key, value;
