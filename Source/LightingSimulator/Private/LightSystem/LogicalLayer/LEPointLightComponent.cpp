...
TArray<FString> ULEPointLightComponent::GetDataAsJson(const int deepth)
{
	TArray<FString> ans;
	...
	ans.Add(ULightEntityHelper::StrStrUnParsor("SourceRadius", FString::SanitizeFloat(this->SourceRadius), Deepth));
...
void ULEPointLightComponent::SetDataFromJson(TArray<FString> dataStrList, int& deepth)
{
	int stackNum = 0;
	FString key, value;
